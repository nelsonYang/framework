 ...
 */
public class RedisWebSessionManager implements WebSessionManager {

    private final Logger logger = LogFactory.getInstance().getLogger(RedisWebSessionManager.class);
    public static final String WEB_SESSION_PREFIX = "WEB_SESSION_";
    ...
    public boolean putKey(String key, SessionEntity value) {
        ...
        if (json != null && !json.isEmpty()) {
            ...
            sessionJedis.set(WEB_SESSION_PREFIX + key, json);
            isSuccess = true;
        }
    ...
    public String getKey(String key) {
        ...
        String session = null;
        Jedis sessionJedis = RedisConfig.buildSessionJedis();
        String jsonStr = sessionJedis.get(WEB_SESSION_PREFIX + key);
    ...
    public boolean clearKey(String key) {
        ...
        boolean isSuccess = false;
        Jedis sessionJedis = RedisConfig.buildSessionJedis();
        Set<String> keys = sessionJedis.keys(WEB_SESSION_PREFIX + "*");
        if (!keys.isEmpty()) {

 ...
 */
public class WebSessionValidateWorkHandler implements WorkHandler {

    private final Logger logger = LogFactory.getInstance().getLogger(WebSessionValidateWorkHandler.class);
    private WorkHandler nextHandler;

    public WebSessionValidateWorkHandler(WorkHandler nextHandler) {
        ...
        if (base64Session != null) {
            ...
            if (contents != null) {
                ...
                if (userName != null && token != null && userId != null) {
                    ...
                    SessionEntity session = applicationContext.getWebSessionManager().getSessionEntityByKey(httpSession.getId() + "-" +userId);

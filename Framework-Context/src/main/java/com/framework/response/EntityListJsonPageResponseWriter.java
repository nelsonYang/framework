 ...
 * @author nelson
 */
public class EntityListJsonPageResponseWriter<T extends Entity> extends ResponseWriter {

    private final Logger logger = LogFactory.getInstance().getLogger(EntityListJsonPageResponseWriter.class);

 ...
 * @author nelson
 */
public class MapListDataJsonResponseWriter extends ResponseWriter {

    private final Logger logger = LogFactory.getInstance().getLogger(MapListDataJsonResponseWriter.class);

 ...
 */
public class LocalWebSessionManager implements WebSessionManager {

    private final Logger logger = LogFactory.getInstance().getLogger(LocalWebSessionManager.class);
